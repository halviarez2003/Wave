...
> Nota (Fase 4): al escribir `prisma/schema.prisma` real, `prisma validate`
> detectó una relación inversa faltante en `Company` (`financialTransactions`)
> — ya corregida abajo. El generador usado es el `prisma-client` de Prisma 6
